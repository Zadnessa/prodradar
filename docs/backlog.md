...
Текущие парсеры (18): Avito, Yandex, T-Bank, Alfa-Bank, Ozon, Sber, VK, Wildberries, Dodo, Купер, Точка, Циан, Контур, Lamoda, ДомКлик, МТС (МТС, МТС Банк, KION, Юрент, MWS.AI — один парсер, несколько брендов через BRAND_MAP), МТС Линк, X5 Group (X5 Tech, Пятёрочка, Перекрёсток, Чижик, X5 Media, X5 Импорт, Много лосося — один парсер, несколько брендов через BRAND_MAP).
