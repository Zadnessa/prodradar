...
Текущие парсеры (16): Avito, Yandex, T-Bank, Alfa-Bank, Ozon, Sber, VK, Wildberries, Dodo, Купер, Точка, Циан, Контур, Lamoda, ДомКлик, МТС (МТС, МТС Банк, KION, Юрент, MWS.AI — один парсер, несколько брендов через BRAND_MAP).
