...
- `/start` — подписка + онбординг (выбор грейда, города, формата, компаний через inline-кнопки)
...
│   ├── onboarding.py      — state machine онбординга
...
- Настройки пользователя (/settings), статистика, порционная выдача вакансий
