...
ProductRadar — Telegram-бот для мониторинга вакансий Product Manager напрямую с карьерных сайтов 8 компаний.
...
Бот работает в продакшене. Следующий этап — подготовка к AI-фазе: более глубокое обогащение вакансий через LLM.
