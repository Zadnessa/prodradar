...
## Этап 5: Расширение компаний (после релиза)

Цель: довести список с 8 до 20-25 компаний.

- [ ] Составить финальный список компаний (владелец продукта)
- [ ] Дочерние компании экосистем — отдельные парсеры: СберЗдоровье, Звук (ex-СберЗвук) и др. имеют собственные карьерные сайты
- [ ] Исследование API каждого нового карьерного сайта (формат: docs/api_spec.md)
