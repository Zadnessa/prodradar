...
Текущие парсеры (23): 2ГИС, Alfa-Bank, Aviasales, Avito, Dodo, Lamoda, Ozon, Sber, T-Bank, VK, Wildberries, X5 Group (X5 Tech, Пятёрочка, Перекрёсток, Чижик, X5 Media, X5 Импорт, Много лосося — один парсер, несколько брендов через BRAND_MAP), Yandex, ДомКлик, Контур, Купер, МТС (МТС, МТС Банк, KION, Юрент, MWS.AI — один парсер, несколько брендов через BRAND_MAP), МТС Линк, СберЗдоровье, Точка, Циан, Касперский (через HH).
