...
6. Квик-вины: Chrome UA, debug.yml (Stream 3F)
...
- [ ] Трёхзонная фильтрация реализована в Stream 3A (TITLE_WHITELIST_PATTERNS + TITLE_BLACKLIST_PATTERNS). Для HH-сканера используются те же паттерны из config.py. Серая зона временно включена в whitelist до AI-фазы (Wave 7).
